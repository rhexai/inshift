...
export default function OurJourney() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-black selection:bg-[#7c3aed] selection:text-white pb-32">
      ...
      {/* Dark Hero Section */}
      <section className="bg-black pt-32 md:pt-72 lg:pt-80 pb-16 md:pb-24 px-5 md:px-12 w-full lg:px-24 overflow-hidden relative">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start justify-between gap-8 md:gap-16 relative z-10">
          
          {/* Left Hero Content */}
          <div className="flex flex-col max-w-xl">
            <div className="text-gray-400 text-xs md:text-sm font-semibold tracking-wide mb-8 md:mb-12 flex space-x-2">
            ...
            <h1 className="text-white text-4xl md:text-7xl font-bold tracking-tight mb-6 md:mb-8">
              Our Story
            </h1>
            
            <p className="text-gray-300 text-lg md:text-xl font-medium mb-10 md:mb-12 max-w-md leading-relaxed">
      ...
      <section className="px-5 md:px-12 py-16 md:py-24 w-full lg:px-24">
      ...
      <section className="px-5 md:px-12 w-full lg:px-24 mb-16 md:mb-32">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-8">Landmark Moments</h2>
          
          <div className="w-full bg-black text-white p-6 md:p-16 flex flex-col lg:flex-row relative shadow-2xl min-h-[500px] md:min-h-[600px] items-stretch">
            ...
            <div className="flex-grow flex flex-col justify-between pt-4 relative">
              ...
              <div className="max-w-md pr-16 animate-in slide-in-from-right-4 fade-in duration-500" key={activeContent.title}>
                 <span className="text-white text-[10px] md:text-xs font-bold tracking-[0.2em] mb-4 block">
                   {activeContent.year}
                 </span>
                 <h3 className="text-2xl lg:text-4xl font-bold leading-tight mb-4 md:mb-6">
                   {activeContent.title}
                 </h3>
